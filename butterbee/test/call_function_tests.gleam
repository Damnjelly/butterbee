...
// }
//
// fn filter_node_remote_value(
//   nodes: List(Result(EvaluateResult, ErrorResponse)),
// ) -> List(Result(EvaluateResult, ErrorResponse)) {
//   nodes
//   |> list.map(fn(node) {
//     case node {
//       Ok(SuccessResult(EvaluateResultSuccess(t, NodeRemote(node_remote_value)))) -> {
